...
#                 continue
            ...
            bndbox = []
            hh = int(bbox.find('ymax').text) -int(bbox.find('ymin').text) 
            ww = int(bbox.find('xmax').text) -int(bbox.find('xmin').text) 
...
#         print(img)
    ...
    def evaluate_detections2(self, all_boxes, output_dir=None):
        """
        all_boxes is a list of length number-of-classes.
        Each list element is a list of length number-of-images.
        Each of those list elements is either an empty list []
